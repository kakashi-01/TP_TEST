...
class TestDataElementManagement:
    ...
    @pytest.mark.parametrize('inData,respData',
                            [get_really_yamldata("test_data.yml", "查询目录树")])
    ...
    @allure.title("测试输入：{inData}")
    @pytest.mark.parametrize('inData,respData',
                             [get_really_yamldata("test_data.yml", "新增分组")])
    ...
    # @pytest.mark.批量导入
    # @allure.title("测试输入：{inData}")
    # # @pytest.mark.parametrize('inData,respData',[get_really_yamldata("test_data.yml", "批量导入")])
