...
class TestAlgTool:
    ...
    @pytest.mark.parametrize('inData,respData',
                             [get_really_yamldata("test_data.yml", "任务队列查询")])
    ...
    @allure.title("测试输入：{inData}")
    @pytest.mark.parametrize('inData,respData',
                             [get_really_yamldata("test_data.yml", "算法模型执行")])
    ...
    @allure.title("测试输入：{inData}")
    @pytest.mark.parametrize('inData,respData',
                             [get_really_yamldata("test_data.yml", "获取算法函数")])
    ...
    @allure.title("测试输入：{inData}")
    @pytest.mark.parametrize('inData,respData',
                             [get_really_yamldata("test_data.yml", "保存算法模型")])
    ...
    @allure.title("测试输入：{inData}")
    @pytest.mark.parametrize('inData,respData',
                             [get_really_yamldata("test_data.yml", "算法超市列表")])
